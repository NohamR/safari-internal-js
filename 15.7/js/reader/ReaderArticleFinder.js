...
function elementLooksLikeEmbeddedIframeTweetWithSrc(e) {
  return (
    ...
    "Twitter Tweet" === e.getAttribute("title")
  );
}
  ...
  (CandidateElement.prototype = {
    ...
    shouldDisqualifyDueToSimilarElements: function (e) {
      ...
      if (
        (s.length ||
          ((r = r.parentElement) &&
            ((s = r.classList).length ||
              ((r = r.parentElement) && (s = r.classList)))),
        s.length)
      ) {
        e || (e = []);
        var c = e.length;
  ...
  (ReaderArticleFinder.prototype = {
    ...
    shouldPruneElement: function (e, t, n) {
      ...
      if ("ul" === s || "ol" === s) {
        ...
        for (d = 0; d < S; ++d) {
          var b = y[d];
          if (SharingRegex.test(b.className)) A++;
          else {
            var x = b.children;
      ...
      if (1 === e.childElementCount) {
        ...
        if (
          "span" === normalizedElementTagName(C) &&
          "converted-anchor" === C.className &&
    ...
    cleanArticleNode: function (e, t, n, i) {
      ...
      var E = [],
        ...
        L =
          I &&
          cachedElementBoundingRect(I).top >
      ...
      this._articleTitleElement &&
        (z = cachedElementBoundingRect(this._articleTitleElement));
      ...
      for (var j = [], G = [], X = [], Y = [], K = []; b; ) {
        try {
          ...
          if (
            ((C.originalElement = b),
            !N && elementAppearsToBeCollapsed(b) && (N = 1),
            (d.has($) || (this.isAMPPage() && f.has($))) && (J = C),
            !J && b !== e && w.has(b)
              ? (J = C)
              : !J && b !== e && F.has(b)
                ? ((C.parentElementBeforePruning = C.parentElement),
                  (J = C),
                  j.push(C))
                : elementIsAHeader(C) &&
                  previousLeafElementForElement(b) === I &&
                  C.classList.add("protected"),
            "twitter-widget" === $ && C.classList.add("protected"),
            !J && ("h1" === $ || "h2" === $))
          )
            if (
          ...
          if (
            ...
            if (C.getAttribute("src")) {
              ...
              b.hasAttribute("loop")
                ? C.setAttribute("data-reader-silent-looped-animation", "")
                : (C.setAttribute("controls", !0),
                  C.removeAttribute("autoplay"),
                  C.removeAttribute("preload"));
            } else J = C;
          ...
          if (!J && "img" !== $ && /img/.test($)) {
            lazyLoadingImageURLForElement(C, b.className) &&
              (((C = changeElementType(C, "img")).originalElement = b),
              ($ = "img"));
          }
            ...
            if (
              (le || ae.length
                ? elementIndicatesItIsASchemaDotOrgImageObject(b) &&
                  !C.querySelector("figure, .auxiliary")
                  ? (oe = "figure")
                  : ee && (oe = "span")
                : (oe = "p"),
              oe)
          ...
          if (
            ...
            !J &&
              C.parentNode &&
              h.has($) &&
              ((C._originalElementDepthInCollapsedArea = N), E.push(C)),
            J ||
            ...
            if (
              (sanitizeElementByRemovingAttributes(C),
            ...
            if (
              ("both" === Q.clear && C.classList.add("clear"),
              "ul" === $ || "ol" === $ || "menu" === $)
            ) {
              if (z && !N && cachedElementBoundingRect(b).top < z.top) J = C;
              else if (
                "none" === Q["list-style-type"] &&
                "none" === Q["background-image"]
              ) {
                for (
              ...
              if (b.querySelector("code")) {
                ...
                e.test(ye) &&
                  (C.classList.add("code-block"), C.classList.add("protected"));
              }
            }
            if (
              (S ||
                "normal" === Q.fontStyle ||
                (u.has($) || (C.style && (C.style.fontStyle = Q.fontStyle)),
                (S = 1)),
              !A && "normal" !== Q.fontWeight)
            ) {
              if (!g.has($)) {
                ...
                (isNaN(Se)
                  ? (Ae = Q.fontWeight)
                  : Se <= 400 || (Se >= 500 && (Ae = "bold")),
                  Ae && C.style && (C.style.fontWeight = Ae));
              }
              A = 1;
            }
              ...
              if (
                (1 !== T ||
                  ...
                  (cachedElementBoundingRect(b).width <= MaximumFloatWidth
                    ? C.setAttribute("class", "auxiliary float " + Q.float)
                    : be || C.classList.add("auxiliary")),
                C.closest(".auxiliary") && b.style)
              ) {
                ...
                1 !== T ||
                  xe ||
                  (C.style.width = cachedElementBoundingRect(b).width + "px");
              }
              ee || c(C, Ne);
            }
            if ("table" === $) y || (y = 1);
              ...
              ((!Ie && C.hasAttribute("src")) ||
                !b.hasAttribute("data-srcset") ||
                C.setAttribute("srcset", b.getAttribute("data-srcset")),
              ...
              if (
                ...
                ("left" !== we && "right" !== we) ||
                  (C.classList.add("float"), C.classList.add(we)),
                !T && !Z)
              ) {
                var Fe,
                  _e = (Fe = cachedElementBoundingRect(b)).width,
                  Oe = Fe.height;
                ...
                "img" === normalizedElementTagName(b.nextElementSibling)
                  ...
                  : imageIsContainedByContainerWithImageAsBackgroundImage(b)
                    ...
                    : (1 === _e && 1 === Oe) ||
                      ...
                      : _e < ImageSizeTiny &&
                        Oe < ImageSizeTiny &&
                        C.setAttribute("class", "reader-image-tiny");
              }
              if (n === CleaningType.MetadataContent)
                ((Fe = cachedElementBoundingRect(b)).width >
              ...
              C instanceof HTMLAnchorElement
                ? ((e = C.getAttribute("href")), (t = HTMLAnchorElement))
                : C instanceof SVGAElement &&
                  ((e = C.getAttribute("xlink:href")), (t = SVGAElement));
              ...
              if (
                ...
                if (
                  !y &&
                  !C.childElementCount &&
                  1 === C.parentElement.childElementCount &&
                  !e.has(normalizedElementTagName(C.parentElement))
                )
                ...
                if (!J) {
                  ...
                  if (
                    1 === C.childElementCount &&
                    "img" === normalizedElementTagName(C.firstElementChild)
                  ) {
              ...
              "pre" === $
                ? (C.style.whiteSpace = Q.whiteSpace)
                : "source" === $ && b.hasAttribute("data-srcset")
                  ? (C.setAttribute("srcset", b.getAttribute("data-srcset")),
                    C.classList.add("protected"))
                  : C instanceof SVGAnimateElement &&
                    "xlink:href" === C.attributes.attributeName.value &&
                    (J = C);
          }
          if (Q && R && !Z) {
            var ze =
              ...
              computedStyleIndicatesElementIsInvisibleDueToClipping(Q);
            if (
              (ze ||
                "img" === $ ||
                (ze =
          ...
          if (
            (!J && elementIsCommentBlock(b) && (J = C),
            !J &&
              z &&
              cachedElementBoundingRect(b).top < z.top &&
        ...
        if (
          (!J || J.parentElement || i || (J = null),
          "div" === $ ? Y.push(C) : "aside" === $ && K.push(C),
          !J)
        ) {
      ...
      for (let e of t.querySelectorAll("iframe")) {
        if (elementLooksLikeEmbeddedTweet(e.originalElement))
          (Xe = this.adoptableSimpleTweetFromTwitterElement(e)) &&
      ...
      for (pe = E.length - 1; pe >= 0; --pe) {
        ((vt = E[pe]).parentNode &&
          this.shouldPruneElement(vt, vt.originalElement, U) &&
          vt.remove(),
        ...
        if (!$e) {
          for (
            var rt = Ze.originalElement.getElementsByTagName("img"),
              ...
              lt = 0,
              ot = 0;
            ot < at && (R && isElementVisible(rt[ot]) && lt++, !(lt > 1));
            ++ot
          );
      ...
      for (pe = 0; pe < yt; ++pe) {
        for (
          var St = Tt[pe], At = [St], Nt = St.nextElementSibling;
          Nt &&
          "p" === normalizedElementTagName(Nt) &&
      ...
      for (pe = 0; pe < It; ++pe) {
        var Mt = j[pe],
          ...
          wt = null;
        if (Lt)
          ((Rt = depthOfElementWithinElement(Lt, t)),
            (wt = selectorForElement(Lt)));
    ...
    articleTitleInformation: function () {
      ...
      var S = function (e, t) {
        ...
        N = A
          ? this.contentFromUniqueMetadataSelector(A, "meta[itemprop=headline]")
          : "",
        b = A
        ...
        C = x.location,
        D = x.title,
        I = S(x, "meta[property='og:title']"),
        M = this.contentFromUniqueMetadataSelector(
          x,
          "meta[property='og:site_name']",
        ),
        L = S(x, "meta[name='twitter:title']"),
        R = S(x, "meta[name='sailthru.headline']"),
        w = this.schemaDotOrgMetadataObjectForArticle(),
        F = w ? w.headline : null,
        _ = this.articleNode(),
      ...
      if (
        (1 === re.length
          ...
          : 1 === ae.length
            ? ((Q = ae[0]).headerText =
                trimmedInnerTextIgnoringTextTransform(Q))
            : 1 === le.length
              ? ((Q = le[0]).headerText =
                  trimmedInnerTextIgnoringTextTransform(Q))
              : 1 === se.length
        ...
        for (V = 0; V < te; ++V) {
          ...
          if (!y.test(he.className)) {
            ...
            if (ue !== M || !I) {
              ...
              (he.closest("li") && (Me *= E),
                (!Q || Me > Q.headerScore) &&
                  (((Q = he).headerScore = Me), (Q.headerText = ue)));
            }
          }
        }
      var qe;
      if (
        (Q &&
          ...
          parseInt(getComputedStyle(Q).fontSize) < T * Be &&
          (Q = null),
        Q)
      ) {
      ...
      Q &&
        (We = n(Q)) &&
        ((Ue = We.href),
        (He = "_blank" === We.getAttribute("target")),
    ...
    articleSubhead: function () {
      ...
      for (S = 0; S < N; ++S) {
        ...
        if (
          (!L && c.has(b.innerText) && (L = !0),
          !L && h && h === b.innerText && (L = !0),
          L || "summary" !== b.getAttribute("itemprop") || (L = !0),
          !L)
        )
          continue;
        if ("meta" === normalizedElementTagName(b)) {
          ...
          if (!w || trimmedInnerTextIgnoringTextTransform(w) !== M) continue;
          b = w;
        } else {
    ...
    scoreNextPageLinkCandidate: function (e) {
      ...
      var A = !1;
      if (e.search)
        for (var N in ((linkParameters = n(e.search)),
      ...
      if (
        ((LinkURLPageSlashNumberMatchRegex.test(e.href) ||
          ...
          (A = !0),
        !A && m === u && stringSimilarity(o, s) < LinkMinimumURLSimilarityRatio)
      )
        return 0;
      ...
      var C =
        ...
        (LinkVerticalDistanceFromArticleWeight * l) /
          LinkMaxVerticalDistanceFromArticle;
      (A && (C += LinkURLSemanticMatchBonus),
        "li" === normalizedElementTagName(e.parentNode) &&
          (C += LinkListItemBonus));
      p = e.innerText;
      return (
        LinkNextMatchRegEx.test(p) && (C += LinkNextMatchBonus),
    ...
    unformattedArticleTextContentIncludingMetadata: function (e) {
      ...
      if (t) {
        ...
        return (
          a &&
            (n +=
              this.plaintextVersionOfNodeAppendingNewlinesBetweenBlockElements(
                a,
              ) + "\n"),
          n + t.innerText
        );
    ...
    pageDescription: function (e) {
      ...
      return (t && (t = t.trim()), t.length ? t : null);
    },
    ...
    pageTypeForTextAnalysis: function (e) {
      ...
      if (
        "http://schema.org/SearchResultsPage" === t ||
        "https://schema.org/SearchResultsPage" === t
      )
    ...
    extractedArticleContent: function () {
      try {
        ...
        return (
          !n.author &&
            r &&
            (n.author = trimmedInnerTextIgnoringTextTransform(r)),
          n
        );
      } catch (e) {
        let t = {};
